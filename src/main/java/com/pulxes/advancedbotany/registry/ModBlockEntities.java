...
public final class ModBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<EngineerHopperBlockEntity>> ENGINEER_HOPPER = BLOCK_ENTITIES.register("engineer_hopper",
            () -> BlockEntityType.Builder.of(EngineerHopperBlockEntity::new, ModBlocks.ENGINEER_HOPPER.get()).build(null));
    public static final RegistryObject<BlockEntityType<NidavellirForgeBlockEntity>> NIDAVELLIR_FORGE = BLOCK_ENTITIES.register("nidavellir_forge",
            () -> BlockEntityType.Builder.of(NidavellirForgeBlockEntity::new, ModBlocks.NIDAVELLIR_FORGE.get()).build(null));
    public static final RegistryObject<BlockEntityType<MagicCraftCrateBlockEntity>> MAGIC_CRAFT_CRATE = BLOCK_ENTITIES.register("magic_craft_crate",
            () -> BlockEntityType.Builder.of(MagicCraftCrateBlockEntity::new, ModBlocks.MAGIC_CRAFT_CRATE.get()).build(null));
    public static final RegistryObject<BlockEntityType<GameBoardBlockEntity>> PLAYING_BOARD = BLOCK_ENTITIES.register("playing_board",
            () -> BlockEntityType.Builder.of(GameBoardBlockEntity::new, ModBlocks.PLAYING_BOARD.get()).build(null));
    public static final RegistryObject<BlockEntityType<BoardFateBlockEntity>> FATE_PLAYING_BOARD = BLOCK_ENTITIES.register("fate_playing_board",
            () -> BlockEntityType.Builder.of(BoardFateBlockEntity::new, ModBlocks.FATE_PLAYING_BOARD.get()).build(null));
    public static final RegistryObject<BlockEntityType<LebethronNaturalCoreBlockEntity>> LEBETHRON_NATURAL_CORE = BLOCK_ENTITIES.register("lebethron_natural_core",
