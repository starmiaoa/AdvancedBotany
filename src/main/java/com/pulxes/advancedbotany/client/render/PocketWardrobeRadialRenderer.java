...
public final class PocketWardrobeRadialRenderer {
    ...
    private static final ResourceLocation GLOW = ResourceLocation.fromNamespaceAndPath(AdvancedBotany.MOD_ID, "textures/misc/glow1.png");
    private static final ResourceLocation PRIORITY_GLOW = ResourceLocation.fromNamespaceAndPath(AdvancedBotany.MOD_ID, "textures/misc/glow2.png");
    ...
    private static void renderPreviewSteve(Minecraft mc, ClientLevel level, PoseStack poseStack,
        ...
        ItemStack[] armorSet = PocketWardrobeItem.getArmorSet(stack, segment, level.registryAccess());
    ...
    private static void vertex(VertexConsumer consumer, Matrix4f matrix, double x, double y, double z, float u, float v,
        ...
        consumer.addVertex(matrix, (float) x, (float) y, (float) z)
                .setColor(colorComponent, colorComponent, colorComponent, alphaComponent)
                .setUv(u, v)
