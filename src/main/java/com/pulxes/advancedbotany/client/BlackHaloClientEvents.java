...
public final class BlackHaloClientEvents {
    private static final ResourceLocation GLOW_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(AdvancedBotany.MOD_ID, "textures/misc/glow.png");
    ...
    public static void renderWorld(RenderLevelStageEvent event) {
        ...
        float alpha = ((float) Math.sin(ticks * 0.2F) * 0.5F + 0.5F)
                * 0.4F + 0.3F;
    ...
    private static void renderStoredBlock(Minecraft minecraft, PoseStack poseStack, MultiBufferSource buffer,
        ...
        ItemStack talisman = BlackHaloItem.getItemForSlot(halo, segment, minecraft.level.registryAccess());
