...
public class AdvancedSparkRenderer extends EntityRenderer<EntityAdvancedSpark> {
    ...
    public AdvancedSparkRenderer(EntityRendererProvider.Context context) {
        ...
        dispersiveIcon = atlas.apply(ResourceLocation.fromNamespaceAndPath("botania", "item/spark_upgrade_rune_dispersive"));
        dominantIcon = atlas.apply(ResourceLocation.fromNamespaceAndPath("botania", "item/spark_upgrade_rune_dominant"));
        recessiveIcon = atlas.apply(ResourceLocation.fromNamespaceAndPath("botania", "item/spark_upgrade_rune_recessive"));
        isolatedIcon = atlas.apply(ResourceLocation.fromNamespaceAndPath("botania", "item/spark_upgrade_rune_isolated"));
        shadowRadius = 0.0F;
    }
