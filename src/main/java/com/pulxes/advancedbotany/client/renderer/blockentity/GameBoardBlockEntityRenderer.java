...
public class GameBoardBlockEntityRenderer implements BlockEntityRenderer<GameBoardBlockEntity> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(AdvancedBotany.MOD_ID, "textures/block/model/gamedice.png");
    private static final ResourceLocation ENEMY_TEXTURE = ResourceLocation.fromNamespaceAndPath(AdvancedBotany.MOD_ID, "textures/block/model/gamedice_enemy.png");
