...
public class AdvancedSparkItem extends Item {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        SparkAttachable attachable = level.getCapability(BotaniaForgeCapabilities.getBlockApiLookupById(SparkAttachable.LOOKUP), pos, null);
        ItemStack stack = context.getItemInHand();
        if (attachable == null || !attachable.canAttachSpark(stack) || SparkAttachable.getAttachedSpark(level, pos) != null) {
