...
public class GameBoardBlockEntity extends BlockEntity {
    ...
    public boolean changeCustomStack(ItemStack stack) {
        ...
        if (customStack.isEmpty() || !ItemStack.isSameItemSameTags(customStack, stack)) {
    ...
    public void load(CompoundTag tag) {
        ...
        customStack = tag.contains(TAG_CUSTOM_STACK) ? ItemStack.of(tag.getCompound(TAG_CUSTOM_STACK)) : ItemStack.EMPTY;
    }
